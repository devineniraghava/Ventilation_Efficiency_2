...
#%%
    ...
    engine = create_engine("mysql+pymysql://wojtek:Password#102@wojtek.mysql.database.azure.com/{}".format(schema),pool_pre_ping=True)
       ...
       # Sub-methods
        ...
        def clean_sql_reg(self):
            ...
            if (self.database == "cbo_summer") or (self.database == "cbo_winter") or (self.database == "eshl_winter"):
                engine = create_engine("mysql+pymysql://wojtek:Password#102@wojtek.mysql.database.azure.com/{}".format("cbo_calibration"),pool_pre_ping=True)
        #        engine = create_engine("mysql+pymysql://root:@34.107.104.23/{}".format("cbo_calibration"),pool_pre_ping=True)
                ...
                engine = create_engine("mysql+pymysql://wojtek:Password#102@wojtek.mysql.database.azure.com/{}".format("eshl_calibration"),pool_pre_ping=True)
        #        engine = create_engine("mysql+pymysql://root:@34.107.104.23/{}".format("eshl_calibration"),pool_pre_ping=True)
            ...
            engine1 = create_engine("mysql+pymysql://wojtek:Password#102@wojtek.mysql.database.azure.com/{}".format(self.database),pool_pre_ping=True)
    ...
    for i in names:
        ...
        final_CO2.append(float(tau.cend()[0]["C_CO2 in ppm"][0]))
